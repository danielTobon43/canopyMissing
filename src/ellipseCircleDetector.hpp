...
void processImage(int /*h*/, void*)
{
    ...
    Mat bimage = img_input >= sliderPos;
    ...
    for(size_t i = 0; i < points.size(); i++){
        ...
        */
        ...
        /*
        std::cout << "center circle: " << box.center << std::endl;
        std::cout << "radius1: " << box.size.width << std::endl;
        std::cout << " radius2: " << box.size.height << std::endl;
        */
